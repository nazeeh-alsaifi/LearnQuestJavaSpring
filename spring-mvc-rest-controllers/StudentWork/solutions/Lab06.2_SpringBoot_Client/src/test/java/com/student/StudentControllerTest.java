...
public class StudentControllerTest {
	...
	void testAddNegative() {
		...
		Assertions.assertThrows(HttpClientErrorException.class, () -> {
			ResponseEntity<?> responseEntity = new RestTemplate().postForEntity(URL, new HttpEntity<Student>(student),
					String.class);
	...
	void testGetOneRequestParam() {
		ResponseEntity<Student> responseEntity = new RestTemplate().exchange(URL + "/single?id={id}", HttpMethod.GET,
